...
ProjectPath            :=/home/franciscokaleb/Documents/IO_Streams/10_Write
...
../build-$(ConfigurationName)/10_Write/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/10_Write/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/franciscokaleb/Documents/IO_Streams/10_Write/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
